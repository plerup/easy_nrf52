...
#define SCL_PIN_NUMBER       NRF_GPIO_PIN_MAP(0, 26)
#define SDA_PIN_NUMBER       NRF_GPIO_PIN_MAP(0, 7)

#define PIN_GNSS_BIAS_ENABLE NRF_GPIO_PIN_MAP(0, 31)
#define PIN_ACC_INT          NRF_GPIO_PIN_MAP(1, 1)
